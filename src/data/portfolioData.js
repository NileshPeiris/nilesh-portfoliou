...
export const certifications = [
  {
    ...
    color: '#00bceb',
    description: 'Acquired fundamental knowledge of AI concepts, modern AI architectures, and practical applications in industry under Cisco Networking Academy.',
  },
  {
    id: 'attackiq-foundations',
    ...
    credentialUrl: 'https://www.credly.com/users/nilesh-peiris',
    color: '#a855f7',
    description: 'Learned the core principles of using the MITRE ATT&CK framework to plan, execute, and analyze threat operations and security defense mapping.',
  },
  {
    id: 'opswat-icip',
    ...
    issuer: 'OPSWAT',
    logo: 'opswat',
    date: 'Expires Jul 2, 2027',
    credentialUrl: 'https://www.credly.com/users/nilesh-peiris',
    color: '#22c55e',
    description: 'Gained an understanding of critical infrastructure cybersecurity requirements, industrial control systems protection, and threat vectors.',
  },
  {
    id: 'attackiq-techniques',
    name: 'Top ATT&CK Techniques',
    issuer: 'AttackIQ',
    logo: 'attackiq',
    date: 'Jul 2, 2026',
    credentialUrl: 'https://www.credly.com/users/nilesh-peiris',
    color: '#a855f7',
    description: 'Learned to identify and emulate the top adversary techniques mapped in MITRE ATT&CK, focusing on security tool validation and controls optimization.',
  },
  {
    id: 'attackiq-navigator',
    ...
    credentialUrl: 'https://www.credly.com/users/nilesh-peiris',
    color: '#a855f7',
    description: 'Practiced threat profiling, threat group tracking, and coverage mapping using the interactive MITRE ATT&CK Navigator tool.',
  },
];
...
export const terminalContent = {
  whoami: [
    ...
    { type: 'output', text: 'Email    : nileshthisunpeiris@gmail.com' },
